...
export const BackgroundBeamsWithCollision = ({
  ...
  const beams = Array.from({ length: 30 }, (_, i) => {
    ...
    return {
      initialX: baseX,
      translateX: baseX + translateOffset,
      duration,
      repeatDelay,
      delay,
      ...maybeClass,
...
>(({ parentRef, containerRef, beamOptions = {} }, rel) => {
  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "absolute left-0 top-20 m-auto h-14 w-px rounded-full bg-gradient-to-t from-primary/70 via-primary to-transparent",
