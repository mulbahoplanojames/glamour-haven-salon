    ...
    <div className="space-y-6 p-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure appointment booking options</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Require a deposit for appointments</p>
            </div>
            <Switch
              id="requireDeposit"
          ...
          {settings.requireDeposit && (
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("depositAmount", Number.parseFloat(e.target.value))}
              />
            </div>
          )}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("maxAdvanceBooking", Number.parseInt(e.target.value))}
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("minAdvanceBooking", Number.parseInt(e.target.value))}
              />
            </div>
          </div>
