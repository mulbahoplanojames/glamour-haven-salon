    ...
    <div className="space-y-6 p-6">
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="siteName" className="pb-2">
                Salon Name
              </Label>
              <Input
                id="siteName"
          ...
          <div>
            <Label htmlFor="siteDescription" className="pb-2">
              Description
            </Label>
            <Textarea
              id="siteDescription"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your salon&apos;s social media presence
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            <Label htmlFor="facebookUrl" className="pb-2">
              Facebook URL
            </Label>
            <Input
              id="facebookUrl"
          ...
          <div>
            <Label htmlFor="instagramUrl" className="pb-2">
              Instagram URL
            </Label>
            <Input
              id="instagramUrl"
          ...
          <div>
            <Label htmlFor="twitterUrl" className="pb-2">
              Twitter URL
            </Label>
            <Input
              id="twitterUrl"
